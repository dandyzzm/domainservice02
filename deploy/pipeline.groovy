...
/* Jenkins - 代码库地址 */
def giturl="ssh://git@gitsvr.mipesoft.com:1022/scmteam/sufservice.git"
def moduleName = 'sufservice'
def appName = 'sufservice'
...
node('master') {
 ...
 node('master') {
     ...
     sh "sed -i 's/sufservice-1.0-SNAPSHOT/sufservice-$gittag/g' deploy/start.sh"
 }
